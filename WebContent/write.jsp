	...
	<div class="container">
		<form method="post" action="writeAction.jsp">
			<table class="table table-default">
					...
					<tbody>						
						<tr>
							<td> <input type="text" class="form-control" name="boardTitle" placeholder="글제목" maxlength="50"> </td>
						</tr>
						<tr>
							<td> <textarea class="form-control" placeholder="글 내용" name="boardContent" maxlength="2048" style="height: 350px;" ></textarea>
					</tbody>					
			</table>
